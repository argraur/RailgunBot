...
import me.argraur.railgun.apis.jenkins.Build;
import me.argraur.railgun.interfaces.Command;
import net.dv8tion.jda.api.entities.Message;

public class JenkinsBuild implements Command {
    private final String command = "jenkins build";
    private final String usage = command + " <jobname>";
    private final String description = "Runs given Jenkins job.";
    ...
    public void call(Message message) {
        ...
        Thread thread = new Thread(new Build(message, RailgunBot.jenkins.getServer()));
        thread.start();
    }
}